public class Driver {
    ...
    private static Expression quote(Expression e) { return new StringLiteral("Change line 10 in Driver.java to return a new Quote"); }     // return new Quote(e); 
    private static Expression unquote(Expression e) { return new StringLiteral("Change line 11 in Driver.java to return a new Unquote"); } // return new Unquote(e); 
